...
for DATASET in 'KDDTrain+' 'KDDTrain+_20Percent'; do
       ...
       python3 randforest_detector.py  --mode='train_randforest'\
                                                 --randforest-params-path='RANDFORESTParams/'$DATASET'/WithoutProjection'\
                                                 --gen-dataset=1\
                                                 --norm-type=''\
       ...
       python3 randforest_detector.py  --mode='test_randforest'\
                                                 ...
                                                 --data-save-path='TrainData/'$DATASET'/'\
                                                 --train-file-name='discriminative_kdd_nsl_processed.npz'\
                                                 --randforest-analysis-path='./RANDFORESTAnalysis/'$DATASET'/WithoutProjection'\
                                                 --train-data-file-path='./NSL_KDD_Dataset/'$DATASET'.txt'
       ...
       python3 randforest_detector.py  --mode='train_randforest_rbm_proj'\
                                                 ...
                                                 --max-depth=$depth\
                                                 --randforest-params-path='RANDFORESTParams/'$DATASET'/WithProjection/RBM'$n'neurons'\
       ...
       python3 randforest_detector.py  --mode='test_randforest_rbm_proj'\
                                                 ...
                                                 --randforest-params-path='RANDFORESTParams/'$DATASET'/WithProjection/RBM'$n'neurons'\
                                                 --data-sampler-params-path='./RBMParams/'$DATASET'/'$n'neurons'\
                                                 --randforest-analysis-path='./RANDFORESTAnalysis/'$DATASET'/WithProjection/RBM'$n'neurons'\
                                                 --train-file-name=$n'_projected_kdd_nsl.npz'\
                                                 --data-save-path='TrainData/'$DATASET'/RBMProjected'\
                                                 --train-data-file-path='./NSL_KDD_Dataset/'$DATASET'.txt'
       done
