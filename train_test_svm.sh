...
for DATASET in 'KDDTrain+' 'KDDTrain+_20Percent'; do
       ...
       python3 svm_detector.py  --mode='train_svm'\
                                                 --svm-params-path='Results/SVMParams/'$DATASET'/WithoutProjection'\
                                                 --gen-dataset=1\
                                                 --c=64 --g=0.00006\
       ...
       python3 svm_detector.py  --mode='test_svm'\
                                                 ...
                                                 --data-save-path='Results/TrainData/'$DATASET'/'\
                                                 --train-file-name='discriminative_kdd_nsl_processed.npz'\
                                                 --svm-analysis-path='./Results/SVMAnalysis/'$DATASET'/WithoutProjection'\
                                                 --train-data-file-path='./NSL_KDD_Dataset/'$DATASET'.txt'
       ...
       for n in 10 20 38 80 100; do
              ...
              python3 svm_detector.py  --mode='train_svm_rbm_proj'\
                                                        ...
                                                        --svm-params-path='Results/SVMParams/'$DATASET'/WithProjection/RBM'$n'neurons'\
              ...
              python3 svm_detector.py  --mode='test_svm_rbm_proj'\
                                                        ...
                                                        --svm-params-path='Results/SVMParams/'$DATASET'/WithProjection/RBM'$n'neurons'\
                                                        --data-sampler-params-path='./Results/RBMParams/'$DATASET'/'$n'neurons'\
                                                        --svm-analysis-path='./Results/SVMAnalysis/'$DATASET'/WithProjection/RBM'$n'neurons'\
                                                        --train-file-name=$n'_projected_kdd_nsl.npz'\
                                                        --data-save-path='Results/TrainData/'$DATASET'/RBMProjected'\
                                                        --train-data-file-path='./NSL_KDD_Dataset/'$DATASET'.txt'
       done
