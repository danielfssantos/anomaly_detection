...
################################### DOS ATTACK ###############################################
################################### TRAIN BBRBM ##############################################
python3 main_script_generative_rbm.py  --mode='train' --rbm-train-type='bbrbm_pcd_dos' --num-epochs=300 --cd-steps=1 --num-hid-nodes=500\
                                       --gen-dataset=0 --sample-visdata=0 --epsilonw=0.001 --epsilonhb=0.001 --epsilonvb=0.001\
                                       --batch-sz=100 --weightcost=0.0 --initialmomentum=0.0 --finalmomentum=0.0

################################### TEST BBRBM ###############################################
python3 main_script_generative_rbm.py  --mode='test' --gen-dataset=0 --rbm-train-type='bbrbm_pcd_dos'\
                                       --batch-sz=100 --sample-visdata=0 --sample-ites=500 --sample-data-repetitions=10


#################################### U2R ATTACK ##############################################
################################### TRAIN BBRBM  #############################################
python3 main_script_generative_rbm.py  --mode='train' --rbm-train-type='bbrbm_pcd_u2r' --num-epochs=300 --cd-steps=1 --num-hid-nodes=500\
...
################################### TEST BBRBM ################################################
python3 main_script_generative_rbm.py  --mode='test' --gen-dataset=0 --rbm-train-type='bbrbm_pcd_u2r'\
                                       --batch-sz=5 --sample-visdata=0 --sample-ites=500 --sample-data-repetitions=10


#################################### R2L ATTACK ###############################################
################################### TRAIN BBRBM  ##############################################
python3 main_script_generative_rbm.py  --mode='train' --rbm-train-type='bbrbm_pcd_r2l' --num-epochs=300 --cd-steps=1 --num-hid-nodes=500\
...
#################################### PROBE ATTACK #############################################
#################################### TRAIN BBRBM  #############################################
python3 main_script_generative_rbm.py  --mode='train' --rbm-train-type='bbrbm_pcd_probe' --num-epochs=300 --cd-steps=1 --num-hid-nodes=500\
                                       --gen-dataset=0 --sample-visdata=0 --epsilonw=0.005 --epsilonhb=0.005 --epsilonvb=0.005\
                                       --batch-sz=100 --weightcost=0.0 --initialmomentum=0.0 --finalmomentum=0.0
